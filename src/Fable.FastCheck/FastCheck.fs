...
type FastCheck =
    ...
    static member inline assert' (prop: AsyncProperty<'T>, ?fastCheckOptions: IFastCheckOptionsProperty list) = 
        Bindings.fc.assert'(prop, ?parameters = (fastCheckOptions |> Option.map (fun p -> createObj !!p)))
    /// Run the property, throw in case of failure.
    /// 
    /// It can be called directly from describe/it blocks of Mocha and Jest.
    static member inline assert' (prop: Property<'T>, ?fastCheckOptions: IFastCheckOptionsProperty list) = 
        Bindings.fc.assert'(prop, ?parameters = (fastCheckOptions |> Option.map (fun p -> createObj !!p)))
    
    /// Run the property, does not throw contrary to assert'.
    static member inline asyncCheck (prop: AsyncProperty<'T>, ?fastCheckOptions: IFastCheckOptionsProperty list) = 
    ...
    /// Run the property, does not throw contrary to assert'.
    static member inline check (prop: Property<'T>, ?fastCheckOptions: IFastCheckOptionsProperty list) = 
    ...
    /// Run the property, does not throw contrary to assert'.
    static member inline promiseCheck (prop: AsyncProperty<'T>, ?fastCheckOptions: IFastCheckOptionsProperty list) = 
        Bindings.fc.check(prop, ?parameters = (fastCheckOptions |> Option.map (fun p -> createObj !!p)))
        |> Promise.map (fun res -> RunDetails(res))
    ...
    ///
    /// Throw in case of inconsistency.
    static member inline promiseModelRun (initialModel: 'Model, real: 'Real, commandIter: seq<IPromiseCommand<'Model,'Real>>) = 
        Bindings.fc.asyncModelRun((fun () -> Bindings.Setup.create initialModel real), commandIter)
    /// Run asynchronous commands over a Model and the Real system.
    ///
    /// Throw in case of inconsistency.
    static member inline promiseModelRun (initialModel: 'Model, real: 'Real, commandIter: IPromiseCommandSeq<'Model,'Real>) = 
        Bindings.fc.asyncModelRun((fun () -> Bindings.Setup.create initialModel real), commandIter)
    ...
    ///
    /// Throw in case of inconsistency.
    static member inline scheduledModelRun (scheduler: AsyncScheduler, initialModel: 'Model, real: 'Real, commandIter: seq<ICommand<'Model,'Real>>) = 
        Bindings.fc.scheduledModelRun(scheduler.scheduler, Bindings.Setup.create initialModel real, commandIter)
    /// Run asynchronous and scheduled commands over a Model and the Real system.
    ///
    /// Throw in case of inconsistency.
    static member inline scheduledModelRun (scheduler: AsyncScheduler, initialModel: 'Model, real: 'Real, commandIter: ICommandSeq<'Model,'Real>) = 
        Bindings.fc.scheduledModelRun(scheduler.scheduler, Bindings.Setup.create initialModel real, commandIter)
    /// Run asynchronous and scheduled commands over a Model and the Real system.
    ///
    /// Throw in case of inconsistency.
    static member inline scheduledModelRun (scheduler: PromiseScheduler, initialModel: 'Model, real: 'Real, commandIter: seq<ICommand<'Model,'Real>>) = 
        Bindings.fc.scheduledModelRun(scheduler.scheduler, Bindings.Setup.create initialModel real, commandIter)
    /// Run asynchronous and scheduled commands over a Model and the Real system.
    ///
    /// Throw in case of inconsistency.
    static member inline scheduledModelRun (scheduler: PromiseScheduler, initialModel: 'Model, real: 'Real, commandIter: ICommandSeq<'Model,'Real>) = 
        Bindings.fc.scheduledModelRun(scheduler.scheduler, Bindings.Setup.create initialModel real, commandIter)
