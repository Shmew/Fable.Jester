...
module Bindings =
    ...
    type FC =
        ...
        abstract scheduledModelRun: Scheduler<'T,'TArgs,'Metadata> * (unit -> Setup<'InitialModel,'Real>) * seq<IPromiseCommand<'Model,'Real>> -> JS.Promise<unit>
        abstract scheduledModelRun: Scheduler<'T,'TArgs,'Metadata> * (unit -> Setup<'InitialModel,'Real>) * IPromiseCommandSeq<'Model,'Real> -> JS.Promise<unit>
        abstract scheduledModelRun: Scheduler<'T,'TArgs,'Metadata> * (unit -> Setup<'InitialModel,'Real>) * seq<IAsyncCommand<'Model,'Real>> -> JS.Promise<unit>
        abstract scheduledModelRun: Scheduler<'T,'TArgs,'Metadata> * (unit -> Setup<'InitialModel,'Real>) * IAsyncCommandSeq<'Model,'Real> -> JS.Promise<unit>
